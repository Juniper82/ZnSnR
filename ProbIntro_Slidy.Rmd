...
### The $mn$ Rule  
: With a set of $m$ elements and a set of $n$ elements, it is possible to form $mn$ peirs containing one element from each.  

The $mn$ rule can be extended to any number of sets. Combinding two sets froms a new set and inturn $mn$ becomes $m_1m_2n$  
...
Because order matters and no person can be choosen twice,  
...
Know as the multinomial coeffieient  
...
The number of undrdered subsets of size $r$ taken with out relacemnt from $n$ objects is the number of combenations of $n$ objects taken $r$ at a time.  
